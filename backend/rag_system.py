...
class RAGSystem:
    ...
    def query(
        ...
        """
        # Create prompt for the AI with clear instructions to use tools
        prompt = f"""Use the search_course_content tool to find relevant information in the course database, then answer this question: {query}"""
